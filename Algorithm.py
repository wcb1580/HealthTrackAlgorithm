...
def predict_disease(symptoms):
    ...
    high_probability_diseases = {disease: prob for disease, prob in disease_probability.items() if prob >= 0}
...
# print(accuracy)
print(predict_disease(['cough', 'congestion', 'acidity']))
print(predict_disease(['cough', 'congestion', 'acidity', 'fatigue']))
print(predict_disease(['fatigue', 'anxiety', 'runny_nose']))
